...
def preprocess_for_eval(image, height, width,
                        central_fraction=0.875, scope=None, center_crop=True):
    ...
    with tf.name_scope(scope, 'eval_image', [image, height, width]):
        ...
        # the original image.
        if central_fraction and center_crop:
...
def preprocess_image(image, height, width,
    ...
    if is_training:
        ...
        return preprocess_for_eval(image, height, width, center_crop=center_crop)
